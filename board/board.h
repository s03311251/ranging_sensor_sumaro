 ...
 * PB3  - SWO ARD_D3                (alternate 0) -> (output opendrain).
 * PB4  - ARD_D5                    (input pullup) -> (output opendrain).
 * PB5  - ARD_D4                    (input pullup) -> (output opendrain).
 * PB6  - ARD_D10                   (input pullup).
 * PB7  - PIN7                      (input pullup).
 * PB8  - ARD_D15                   (input pullup).
 * PB9  - ARD_D14                   (input pullup).
 * PB10 - ARD_D6                    (input pullup) -> (output opendrain).
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_ARD_A3) |     \
                                     ...
                                     PIN_OTYPE_OPENDRAIN(GPIOB_SWO) |        \
                                     PIN_OTYPE_OPENDRAIN(GPIOB_ARD_D5) |     \
                                     PIN_OTYPE_OPENDRAIN(GPIOB_ARD_D4) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOB_ARD_D10) |    \
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN7) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOB_ARD_D15) |    \
                                     PIN_OTYPE_PUSHPULL(GPIOB_ARD_D14) |    \
                                     PIN_OTYPE_OPENDRAIN(GPIOB_ARD_D6) |     \
